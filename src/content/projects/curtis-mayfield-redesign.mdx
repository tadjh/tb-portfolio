...
A modren redesign for a legendary GRAMMY Award Winning R&B and Soul musician Curtis Mayfield.
...
<figure>
  <video autoPlay muted loop>
    <source
      src="/src/assets/videos/Curtis-Mayfield-Merch-Carousel-720p.mp4"
      type="video/mp4"
    />
  </video>
  {/* prettier-ignore */}
...
<figure>
  <BeforeAfter
    before="/src/assets/images/Curtis-Mayfield-Music-Archive-Before-1024x576.jpg"
    after="/src/assets/images/Curtis-Mayfield-Music-Archive-1024x576.jpg"
    client:load
  />
  {/* prettier-ignore */}
...
<figure>
  <BeforeAfter
    before="/src/assets/images/Curtis-Mayfield-Music-Single-Before-1024x576.jpg"
    after="/src/assets/images/Curtis-Mayfield-Music-Single-1024x576.jpg"
    client:load
  />
  {/* prettier-ignore */}
...
<figure>
  <video autoPlay muted loop>
    <source
      src="/src/assets/videos/Curtis-Mayfield-Animated-Timeline-720p.mp4"
      type="video/mp4"
    />
  </video>
  {/* prettier-ignore */}
