...
shortlink: chatjack
sortOrder: 1
hero: /src/assets/images/chatjack-featued-image.png
categories:
  - Full-Stack
  - Game Development
  - Twitch Integration
...
<figure>
  ...
  {/* prettier-ignore */}
  <figcaption>Watch ChatJack in action as the community collaborates to beat the dealer.</figcaption>
</figure>
...
<figure>
  <Image
    ...
    class="animate-fadeInView max-w-4xl shadow-2xl"
  />
  <figcaption>A screenshot of the ChatJack game interface.</figcaption>
</figure>
